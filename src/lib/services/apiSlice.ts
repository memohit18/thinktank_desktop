...
export const apiSlice = createApi({
  ...
  tagTypes: ['Auth', 'CodeSession', 'QuestionFilters', 'Problems', 'Profile', 'Submissions', 'UserProgress', 'Roadmaps', 'FitnessProfile', 'FitnessGoals', 'Transformation', 'Foods', 'FoodCategories', 'FoodPreferences', 'NutritionPreferences', 'Diet', 'MealPlan'],
  endpoints: () => ({}),
});
